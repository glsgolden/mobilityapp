package com.simple.mobility.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.simple.mobility.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.simple.mobility.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            cm.createCache(com.simple.mobility.domain.MObilyRecord.class.getName(), jcacheConfiguration);
